...
public class Currency {
    ...
    public void defaultValues() {
        ...
        switch (currency) {
            case "US Dollar":
                ...
                this.exchangeValues.put("RUB", 134.0);
                break;
            case "Euro":
                ...
                this.exchangeValues.put("RUB", 146.29);
                break;
            case "Russian rub":
                this.exchangeValues.put("USD", 0.00746);
                this.exchangeValues.put("EUR", 0.00684);
                this.exchangeValues.put("GBP", 0.00572);
                this.exchangeValues.put("CHF", 0.00698);
                this.exchangeValues.put("CNY", 0.0473);
                this.exchangeValues.put("JPY", 0.875);
            ...
            case "British Pound":
                ...
                this.exchangeValues.put("RUB", 174.71);
                break;
            case "Swiss Franc":
                ...
                this.exchangeValues.put("RUB", 143.32);
                break;
            case "Chinese Yuan Renminbi":
                ...
                this.exchangeValues.put("RUB", 21.14);
                break;
            case "Japanese Yen":
                ...
                this.exchangeValues.put("RUB", 1.14);
                break;
        }
    }
    ...
    public static ArrayList<Currency> init() {
        ...
        currencies.add( new Currency("Russian rub", "RUB"));
